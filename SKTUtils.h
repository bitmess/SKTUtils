...
#define ccv(dx, dy)                 CGVectorMake(dx, dy)
#define ccr(x, y, w, h)             CGRectMake(x, y, w, h)
#define CGRectCenter(rect)          ccp(CGRectGetMidX(rect), CGRectGetMidY(rect))

#define d2r(d)                      DegreesToRadians(d)
#define r2d(r)                      RadiansToDegrees(r)
